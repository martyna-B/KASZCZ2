...
plt.scatter(H_20, autocorr_20_after, s = 10, label="ACF szeregu $\{X_t\}$")
plt.legend()
plt.xlabel("$h$")
plt.ylabel("ACF")
...
Podobnie jak dla funkcji ACF, również dla PACF niektóre wartości obliczone dla szeregu $\{X_t\}$ wykraczają poza przedział ufności.
